// =============================================================
// SPRACHWECHSEL – NUR data-i18n / data-i18n-html
// =============================================================
...
function switchLang(lang) {
    ...
    // 2. Alle Texte übersetzen (nur Text)
    ...
    if (typeof applyDropcaps === 'function') {
        applyDropcaps();
    }
}
